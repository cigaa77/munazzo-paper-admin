...
var AccountPlatformWidgetComponent = /** @class */ (function () {
    ...
    AccountPlatformWidgetComponent.prototype.updateAccountPlatform = function () {
        var _this = this;
        this.accountPlatformService.updateAccountPlatform(this.editedAccountPlatform).subscribe(function (t) {
            if (t) {
                _this.editAcountPlatformForm = false;
                _this.editedAccountPlatform = {};
            }
    ...
    AccountPlatformWidgetComponent.prototype.goPlatformSettings = function (accountplatform) {
        // this.platformSettingList=false;
        // this.IntegrationFilterList=false;
        // localStorage.removeItem("accountplatformId");
        // localStorage.setItem("accountplatformId", accountplatform.ID.toString());
        // this.router.navigate(['/widget/platformsettings']);
